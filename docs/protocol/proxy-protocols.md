...
related: ["[[http]]", "[[protocol/socks5]]", "[[protocol/trojan]]", "[[protocol/vless]]", "[[protocol/shadowsocks]]", "[[docs/protocol/trojan-gfw]]", "[[pipeline]]", "[[protocol]]", "[[stealth]]", "[[agent]]"]
---

> 相关：[[http]] | [[protocol/socks5]] | [[protocol/trojan]] | [[protocol/vless]] | [[protocol/shadowsocks]] | [[docs/protocol/trojan-gfw]] | [[pipeline]] | [[protocol]] | [[stealth]] | [[agent]]
...
- **Prism 实现**：[[protocol/socks5]] — 完整支持 CONNECT、UDP Associate 和 AUTH 子协商
...
- **Prism 实现**：[[protocol/trojan]] — C++23 协程实现，支持 CONNECT / UDP / MUX 三种命令
- **原始实现参考**：[[docs/protocol/trojan-gfw]] — trojan-gfw/trojan 的协议规范与 Prism 实现的差异
...
- **Prism 实现**：[[protocol/vless]] — 支持 TCP / UDP / MUX 三种命令，AddnlInfoLen 必须为 0
...
- **Prism 实现**：[[protocol/shadowsocks]] — 作为 fallback 协议，当 TLS 内层数据不匹配 Trojan/VLESS 时回退到此
...
| 协议 | 原始项目 | Prism 实现差异 |
|------|----------|----------------|
| Trojan | [trojan-gfw/trojan](https://github.com/trojan-gfw/trojan) | C++23 协程、PMR 内存、MUX 扩展。详见 [[docs/protocol/trojan-gfw]] |
...
- [[protocol/trojan]] — Prism 中的 Trojan 协议实现
- [[docs/protocol/trojan-gfw]] — Trojan-GFW 原始协议规范
