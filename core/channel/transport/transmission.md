...
- [[core/channel/transport/reliable|reliable]] — TCP 可靠传输（叶子节点，type::tcp）
- [[core/channel/transport/unreliable|unreliable]] — UDP 不可靠传输（叶子节点，type::udp）
- [[core/channel/transport/encrypted|encrypted]] — TLS 加密传输（装饰器）
- [[core/channel/adapter/preview|preview]] — 预读重放装饰器
- [[core/channel/adapter/snapshot|snapshot]] — 传输层快照装饰器
- [[core/crypto/aead|seal]] — 加密封装装饰器
