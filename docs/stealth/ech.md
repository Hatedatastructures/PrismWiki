...
| 方案 | ECH 支持 | 说明 |
|------|----------|------|
| [[stealth/anytls]] | 支持 | `ech_key` 配置项，Tier 1 verify 中解密 |
| [[stealth/trusttunnel]] | 可扩展 | 当前未直接集成 |
| [[stealth/restls]] | 可扩展 | 当前未直接集成 |
| [[stealth/shadowtls]] | 不需要 | 认证在 SessionID 中，与 SNI 无关 |
